...
plot(datetime, subsetdate$Global_active_power, type="n", xlab="", ylab="Global Active Power", cex.lab=0.8)
lines(datetime, subsetdate$Global_active_power)
plot(datetime, subsetdate$Voltage, type="n", xlab="datetime", ylab="Voltage", cex.lab=0.8)
lines(datetime, subsetdate$Voltage)
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(5,5),col=c("black","red","blue"),bty="n", cex = 0.75)
plot(datetime, subsetdate$Global_reactive_power, type="n", xlab="datetime", ylab="Global_reactive_power", cex.lab=0.75)
lines(datetime, subsetdate$Global_reactive_power)
dev.off()